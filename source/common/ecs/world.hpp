...
namespace our
{
    ...
    public:
        ...
        Entity *add()
        {
            ...
            entity->world = this; // Link the entity back to this world so it can access world-level data

            entities.insert(entity); // Register the entity in the main entities container
